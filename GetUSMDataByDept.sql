...
AS
	...
	LEFT JOIN adt.FACT_STAFFED_BEDS_BY_DEPARTMENT staffedBeds --granularity = dept. how many staffed beds are available per dept. Use current value for making current policy. can rerun as needed.
